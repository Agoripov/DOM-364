...
// const calculateSquaresButton = document.getElementById('calculateSquares');
//         const paragraphs = document.querySelectorAll('p');
...
//     const characters = 'СпартакЗенитЦСКАЛокомотивАхматРостовКраснодарРубин';
//     let randomString = '';
//     for (let i = 0; i < 8; i++) {
...
//         resultParagraph.textContent = `Температура в градусах Цельсия: ${celsius.toFixed(2)}°C`;
//     } else {
//         resultParagraph.textContent = 'Пожалуйста, введите корректное значение в градусах Фаренгейта.';
//     }
// });
